...
namespace Microsoft.PowerBI.Api
{
    ...
    public partial class DataflowsClient
    {
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<DataflowTransactionStatus>> CancelDataflowTransactionAsync(Guid groupId, Guid transactionId, CancellationToken cancellationToken = default)
        {
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<DataflowTransactionStatus> CancelDataflowTransaction(Guid groupId, Guid transactionId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataflowsClient.CancelDataflowTransaction");
            scope.Start();
            try
