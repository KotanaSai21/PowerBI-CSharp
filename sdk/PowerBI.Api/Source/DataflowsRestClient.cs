...
namespace Microsoft.PowerBI.Api
{
    internal partial class DataflowsRestClient
    {
        ...
        internal HttpMessage CreateCancelDataflowTransactionRequest(Guid groupId, Guid transactionId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public async Task<Response<DataflowTransactionStatus>> CancelDataflowTransactionAsync(Guid groupId, Guid transactionId, CancellationToken cancellationToken = default)
        {
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public Response<DataflowTransactionStatus> CancelDataflowTransaction(Guid groupId, Guid transactionId, CancellationToken cancellationToken = default)
        {
            using var message = CreateCancelDataflowTransactionRequest(groupId, transactionId);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
