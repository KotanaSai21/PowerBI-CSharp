...
namespace Microsoft.PowerBI.Api
{
    ...
    public partial class GoalNotesClient
    {
        ...
        public GoalNotesClient(Guid groupId, Guid scorecardId, Guid goalId, DateTimeOffset timestamp, Guid noteId, TokenCredential credential, Uri endpoint = null, PowerBIClientOptions options = null)
        {
            if (credential == null)
            {
            ...
            RestClient = new GoalNotesRestClient(_clientDiagnostics, _pipeline, groupId, scorecardId, goalId, timestamp, noteId, endpoint);
        }
        ...
        internal GoalNotesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Guid groupId, Guid scorecardId, Guid goalId, DateTimeOffset timestamp, Guid noteId, Uri endpoint = null)
        {
            RestClient = new GoalNotesRestClient(clientDiagnostics, pipeline, groupId, scorecardId, goalId, timestamp, noteId, endpoint);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<GoalNote>> PreviewPostAsync(GoalNoteRequest goalNote, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalNotesClient.PreviewPost");
            scope.Start();
            try
            {
                return await RestClient.PreviewPostAsync(goalNote, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<GoalNote> PreviewPost(GoalNoteRequest goalNote, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalNotesClient.PreviewPost");
            scope.Start();
            try
            {
                return RestClient.PreviewPost(goalNote, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<GoalNote>> PreviewPatchByIDAsync(GoalNoteRequest goalNote, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalNotesClient.PreviewPatchByID");
            scope.Start();
            try
            {
                return await RestClient.PreviewPatchByIDAsync(goalNote, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<GoalNote> PreviewPatchByID(GoalNoteRequest goalNote, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalNotesClient.PreviewPatchByID");
            scope.Start();
            try
            {
                return RestClient.PreviewPatchByID(goalNote, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
