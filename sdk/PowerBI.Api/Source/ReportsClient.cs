...
namespace Microsoft.PowerBI.Api
{
    ...
    public partial class ReportsClient
    {
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<Stream>> ExportReportInGroupAsync(Guid groupId, Guid reportId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ReportsClient.ExportReportInGroup");
            scope.Start();
            try
            {
                return await RestClient.ExportReportInGroupAsync(groupId, reportId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<Stream> ExportReportInGroup(Guid groupId, Guid reportId, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ReportsClient.ExportReportInGroup");
            scope.Start();
            try
            {
                return RestClient.ExportReportInGroup(groupId, reportId, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
