...
namespace Microsoft.PowerBI.Api
{
    ...
    public partial class GoalValuesClient
    {
        ...
        public GoalValuesClient(Guid groupId, Guid scorecardId, Guid goalId, DateTimeOffset timestamp, TokenCredential credential, Uri endpoint = null, PowerBIClientOptions options = null)
        {
            if (credential == null)
            {
            ...
            RestClient = new GoalValuesRestClient(_clientDiagnostics, _pipeline, groupId, scorecardId, goalId, timestamp, endpoint);
        }
        ...
        internal GoalValuesClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Guid groupId, Guid scorecardId, Guid goalId, DateTimeOffset timestamp, Uri endpoint = null)
        {
            RestClient = new GoalValuesRestClient(clientDiagnostics, pipeline, groupId, scorecardId, goalId, timestamp, endpoint);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<GoalValues>> PreviewGetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewGet");
            scope.Start();
            try
            {
                return await RestClient.PreviewGetAsync(expand, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<GoalValues> PreviewGet(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewGet");
            scope.Start();
            try
            {
                return RestClient.PreviewGet(expand, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<GoalValue>> PreviewPostAsync(GoalValueCreateRequest goalValue, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewPost");
            scope.Start();
            try
            {
                return await RestClient.PreviewPostAsync(goalValue, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<GoalValue> PreviewPost(GoalValueCreateRequest goalValue, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewPost");
            scope.Start();
            try
            {
                return RestClient.PreviewPost(goalValue, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<GoalValue>> PreviewGetByIDAsync(string expand = null, CancellationToken cancellationToken = default)
        {
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<GoalValue> PreviewGetByID(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewGetByID");
            scope.Start();
            try
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual async Task<Response<GoalValue>> PreviewPatchByIDAsync(GoalValue goalValue, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewPatchByID");
            scope.Start();
            try
            {
                return await RestClient.PreviewPatchByIDAsync(goalValue, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public virtual Response<GoalValue> PreviewPatchByID(GoalValue goalValue, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("GoalValuesClient.PreviewPatchByID");
            scope.Start();
            try
            {
                return RestClient.PreviewPatchByID(goalValue, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
