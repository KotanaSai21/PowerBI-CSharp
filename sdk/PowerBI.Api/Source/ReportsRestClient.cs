...
namespace Microsoft.PowerBI.Api
{
    internal partial class ReportsRestClient
    {
        ...
        internal HttpMessage CreateExportReportInGroupRequest(Guid groupId, Guid reportId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public async Task<Response<Stream>> ExportReportInGroupAsync(Guid groupId, Guid reportId, CancellationToken cancellationToken = default)
        {
            using var message = CreateExportReportInGroupRequest(groupId, reportId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public Response<Stream> ExportReportInGroup(Guid groupId, Guid reportId, CancellationToken cancellationToken = default)
        {
            using var message = CreateExportReportInGroupRequest(groupId, reportId);
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
