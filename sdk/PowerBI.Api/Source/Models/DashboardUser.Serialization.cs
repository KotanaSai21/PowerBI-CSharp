...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class DashboardUser : IUtf8JsonSerializable
    {
        ...
        internal static DashboardUser DeserializeDashboardUser(JsonElement element)
        {
            ...
            return new DashboardUser(emailAddress.Value, displayName.Value, identifier, graphId.Value, userType.Value, principalType, profile.Value, dashboardUserAccessRight);
        }
    }
}
