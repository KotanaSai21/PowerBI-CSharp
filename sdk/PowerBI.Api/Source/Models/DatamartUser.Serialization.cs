...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class DatamartUser : IUtf8JsonSerializable
    {
        ...
        internal static DatamartUser DeserializeDatamartUser(JsonElement element)
        {
            ...
            return new DatamartUser(emailAddress.Value, displayName.Value, identifier, graphId.Value, userType.Value, principalType, profile.Value, datamartUserAccessRight);
        }
    }
}
