...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class PipelineStageDatamart
    {
        internal static PipelineStageDatamart DeserializePipelineStageDatamart(JsonElement element)
        {
            ...
            return new PipelineStageDatamart(artifactId, artifactDisplayName.Value, Optional.ToNullable(sourceArtifactId), Optional.ToNullable(targetArtifactId), Optional.ToNullable(lastDeploymentTime));
        }
    }
}
