...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class PipelineStageDataset
    {
        internal static PipelineStageDataset DeserializePipelineStageDataset(JsonElement element)
        {
            ...
            return new PipelineStageDataset(artifactId, artifactDisplayName.Value, Optional.ToNullable(sourceArtifactId), Optional.ToNullable(targetArtifactId), Optional.ToNullable(lastDeploymentTime));
        }
    }
}
