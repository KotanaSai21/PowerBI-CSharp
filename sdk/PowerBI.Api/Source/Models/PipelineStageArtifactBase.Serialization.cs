...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class PipelineStageArtifactBase
    {
        internal static PipelineStageArtifactBase DeserializePipelineStageArtifactBase(JsonElement element)
        {
            ...
            return new PipelineStageArtifactBase(artifactId, artifactDisplayName.Value, Optional.ToNullable(sourceArtifactId), Optional.ToNullable(targetArtifactId), Optional.ToNullable(lastDeploymentTime));
        }
    }
}
