...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class DataflowBaseProperties : IUtf8JsonSerializable
    {
        ...
        internal static DataflowBaseProperties DeserializeDataflowBaseProperties(JsonElement element)
        {
            ...
            return new DataflowBaseProperties(objectId, name.Value, description.Value, modelUrl.Value, configuredBy.Value, modifiedBy.Value, Optional.ToNullable(modifiedDateTime), Optional.ToList(users));
        }
    }
}
