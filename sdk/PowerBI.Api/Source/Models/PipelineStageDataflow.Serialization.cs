...
namespace Microsoft.PowerBI.Api.Models
{
    public partial class PipelineStageDataflow
    {
        internal static PipelineStageDataflow DeserializePipelineStageDataflow(JsonElement element)
        {
            ...
            return new PipelineStageDataflow(artifactId, artifactDisplayName.Value, Optional.ToNullable(sourceArtifactId), Optional.ToNullable(targetArtifactId), Optional.ToNullable(lastDeploymentTime));
        }
    }
}
