...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class ReportBaseProperties
    {
        ...
        internal ReportBaseProperties(Guid id, string name, string datasetId, string appId, string description, ReportBasePropertiesReportType? reportType, Guid? originalReportId)
        {
            Id = id;
            Name = name;
            DatasetId = datasetId;
