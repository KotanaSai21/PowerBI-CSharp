...
namespace Microsoft.PowerBI.Api.Models
{
    ...
    public partial class WorkspaceInfoDataset : DatasetBaseProperties
    {
        ...
        internal WorkspaceInfoDataset(string id, string name, string configuredBy, DateTimeOffset? createdDate, string contentProviderType, string description, IList<DependentDataflow> upstreamDataflows, IList<Table> tables, string schemaRetrievalError, bool? schemaMayNotBeUpToDate, IList<Expression> expressions, IList<Role> roles, EndorsementDetails endorsementDetails, SensitivityLabel sensitivityLabel, string targetStorageMode, IList<DatasourceUsage> datasourceUsages, IList<DatasourceUsage> misconfiguredDatasourceUsages, IList<DependentDatamarts> upstreamDatamart, IList<DependentDataset> upstreamDatasets, IList<DependentDatamart> upstreamDatamarts, IList<DatasetUser> users) : base(id, name, configuredBy, createdDate, contentProviderType, description, upstreamDataflows)
        {
            Tables = tables;
