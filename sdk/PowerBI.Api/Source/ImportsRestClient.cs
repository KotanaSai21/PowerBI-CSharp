...
namespace Microsoft.PowerBI.Api
{
    internal partial class ImportsRestClient
    {
        ...
        internal HttpMessage CreatePostImportRequest(string datasetDisplayName, ImportInfo importInfo, ImportConflictHandlerMode? nameConflict, bool? skipReport, bool? overrideReportLabel, bool? overrideModelLabel)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            content.JsonWriter.WriteObjectValue<ImportInfo>(importInfo);
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public async Task<Response<Import>> PostImportAsync(string datasetDisplayName, ImportInfo importInfo, ImportConflictHandlerMode? nameConflict = null, bool? skipReport = null, bool? overrideReportLabel = null, bool? overrideModelLabel = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreatePostImportRequest(datasetDisplayName, importInfo, nameConflict, skipReport, overrideReportLabel, overrideModelLabel);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public Response<Import> PostImport(string datasetDisplayName, ImportInfo importInfo, ImportConflictHandlerMode? nameConflict = null, bool? skipReport = null, bool? overrideReportLabel = null, bool? overrideModelLabel = null, CancellationToken cancellationToken = default)
        {
            if (datasetDisplayName == null)
            {
                throw new ArgumentNullException(nameof(datasetDisplayName));
        ...
        internal HttpMessage CreatePostImportInGroupRequest(Guid groupId, string datasetDisplayName, ImportInfo importInfo, ImportConflictHandlerMode? nameConflict, bool? skipReport, bool? overrideReportLabel, bool? overrideModelLabel)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public async Task<Response<Import>> PostImportInGroupAsync(Guid groupId, string datasetDisplayName, ImportInfo importInfo, ImportConflictHandlerMode? nameConflict = null, bool? skipReport = null, bool? overrideReportLabel = null, bool? overrideModelLabel = null, CancellationToken cancellationToken = default)
        {
            if (datasetDisplayName == null)
            {
                throw new ArgumentNullException(nameof(datasetDisplayName));
            ...
            using var message = CreatePostImportInGroupRequest(groupId, datasetDisplayName, importInfo, nameConflict, skipReport, overrideReportLabel, overrideModelLabel);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// &lt;br&gt;&lt;br&gt;
        /// </remarks>
        public Response<Import> PostImportInGroup(Guid groupId, string datasetDisplayName, ImportInfo importInfo, ImportConflictHandlerMode? nameConflict = null, bool? skipReport = null, bool? overrideReportLabel = null, bool? overrideModelLabel = null, CancellationToken cancellationToken = default)
        {
            if (datasetDisplayName == null)
            {
                throw new ArgumentNullException(nameof(datasetDisplayName));
